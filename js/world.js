class World {
  ...
  #generateTrees() {
    ...
    while (tryCount < 100) {
      ...
      // avoiding three in the middle of nowhere
      if (keep) {
  ...
  draw(context, viewPoint) {
    ...
    for (const segment of this.graph.segments) {
      segment.draw(context, { color: "white", width: 4, dash: [10, 10] });
    }
